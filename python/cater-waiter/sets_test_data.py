...
new_recipe = [('random inexistent plate', 'random inexistent plate', {'inexistent ingredient', 'chopped parsley', 'pomegranate molasses', 'spring onion', 'lemon juice', 'olive oil', 'bulgur', 'tomato paste', 'tomato', 'persian cucumber'})]
empty_str = ""
