...
class LittleSistersEssayTest(unittest.TestCase):
    ...
    def test_sentence_ending_without_question_mark(self):
    ...
    def test_sentence_ending_with_exclamation_mark(self):
    ...
    def test_sentence_ending_without_exclamation_mark(self):
